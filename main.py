...
class notification_daemon:
    ...
    def start(self):
        ...
        while True:
            try:
                notifications = github_request("notifications", {
                    "per_page": 100
                })
    ...
    def process_notifications(self, all_notifications):
        def is_target(n):
            ...
            is_primary = n["subject"]["type"] not in [
                "Commit",
    ...
    def notify(self, id, title, subject):
        ...
        notification.add_action(
            "default", "Open GitHub", self.on_action, {"subject": subject}
        )
    ...
    def on_action(self, notification, name, n):
        ...
        subject = n["subject"]
        url = parse_github_url(subject["url"], subject["type"])
        webbrowser.open(url)
